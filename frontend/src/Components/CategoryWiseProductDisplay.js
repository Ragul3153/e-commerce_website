...
import scrollTop from '../helpers/scrollTop'
  ...
  return (
    <div className='container mx-auto px-4 my-6 relative'>
        ...
        <div className='flex grid-cols-[repeat(auto-fit,minmax(300px, 320px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none transition-all'>
                    ...
                    <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow'>
                        ...
                        <div className='p-4 grid gap-3'>
                            ...
                            <div className='flex gap-3'>
                                <p className='text-green-600 foont-medium p-1 animate-pulse rounded-full bg-slate-200 w-full py-2'></p>
