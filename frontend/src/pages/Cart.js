    ...
    <div className='container mx-auto'>
        ...
        <div className='w-full max-w-3xl '>
      {
            loading  ? (
              loadingCart.map(el => {
                return(
                   <div key={el+"Add To Cart Loading"} className='w-full bg-white h-32 my-2 border border-slate-300 animate-pulse rounded'>
              ...
              return(
                <div key={product?._id+"Add To Cart Loading"} className='w-full bg-white h-32 my-2 border border-slate-300 rounded grid grid-cols-[128px,1fr]'>
                  ...
                  <div className='px-4 py-2 relative'>
                    ...
                    <p className='capitalize textx-slate-500'>product?.productId.category</p>
          ...
          { /**Summary */ }
          <div className='mt-5 lg:mt-0 w-full mx-w-sm'>
            {
            loading ? (
